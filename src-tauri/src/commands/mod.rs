...
/// Get an API key for a post-processing provider (reads from keyring with store fallback).
#[specta::specta]
#[tauri::command]
pub fn get_post_process_api_key(app: AppHandle, provider_id: String) -> Result<String, String> {
    Ok(crate::settings::get_api_key_for_provider(&app, &provider_id))
}
