...
This guide covers how to set up the development environment and build TypeVoice from source across different platforms.
...
```bash
git clone git@github.com:NABILNET-ORG/TypeVoice.git
cd TypeVoice
```
