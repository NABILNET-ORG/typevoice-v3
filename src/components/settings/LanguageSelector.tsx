    ...
    >
      <div className="flex items-center space-x-1">
        <div className="relative" ref={dropdownRef}>
          <button
            type="button"
            className={`px-2 py-1 text-sm font-semibold bg-mid-gray/10 border border-border rounded min-w-[200px] text-left flex items-center justify-between transition-all duration-150 ${
            ...
            <div className="absolute top-full left-0 right-0 mt-1 bg-background border border-border rounded shadow-lg z-50 max-h-60 overflow-hidden">
              ...
              <div className="p-2 border-b border-border">
                <input
                  ...
                  className="w-full px-2 py-1 text-sm bg-mid-gray/10 border border-border rounded focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent"
                />
              </div>
                ...
                {filteredLanguages.length === 0 ? (
                  ...
                  filteredLanguages.map((language) => (
                    <button
                      key={language.value}
                      type="button"
                      className={`w-full px-2 py-1 text-sm text-left hover:bg-accent/10 transition-colors duration-150 ${
