...
export const AudioPlayer: React.FC<AudioPlayerProps> = ({
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <button
        onClick={togglePlay}
        className="transition-colors cursor-pointer text-text hover:text-accent"
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          style={{
            background: `linear-gradient(to right, var(--color-accent) 0%, var(--color-accent) ${progressPercent}%, rgba(128, 128, 128, 0.15) ${progressPercent}%, rgba(128, 128, 128, 0.15) 100%)`,
          }}
        />
